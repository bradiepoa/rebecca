# Generated by Django 3.1.2 on 2022-07-09 23:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('declined', 'Declined'), ('pending', 'Pending'), ('picked', 'Picked'), ('admitted', 'Admitted')], default='pending', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Hospital',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('permanent', 'Permanent'), ('temperory', 'Temperory'), ('not available', 'Not available')], default='temperory', max_length=200, null=True)),
                ('Hospital_Name', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
